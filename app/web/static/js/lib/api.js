...
export const ENDPOINTS = {
  ...
  sessionLabels: (id) => `${API_PREFIX}/sessions/${id}/labels`,
  ...
  workbenchDbExplain: () => `${API_PREFIX}/workbench/explain`,
  workbenchDbNl2sql: () => `${API_PREFIX}/workbench/nl2sql`,
  workbenchDbDictionary: (dbName) =>
    `${API_PREFIX}/workbench/dictionary?db_name=${encodeURIComponent(dbName || "")}`,
  workbenchSavedQuestions: (dbName) =>
    `${API_PREFIX}/workbench/saved-questions?db_name=${encodeURIComponent(dbName || "")}`,
  workbenchSaveQuestion: () => `${API_PREFIX}/workbench/saved-questions`,
  workbenchApproveQuestion: (id) => `${API_PREFIX}/workbench/saved-questions/${id}/approve`,
  workbenchDeleteQuestion: (id, dbName) =>
    `${API_PREFIX}/workbench/saved-questions/${id}?db_name=${encodeURIComponent(dbName || "")}`,
  workbenchDbSchemaTree: (dbName) =>
    `${API_PREFIX}/workbench/schema-tree${dbName ? `?db_name=${encodeURIComponent(dbName)}` : ""}`,
