"""Tests for web/metadata_checker.py — comment coverage stats + COMMENT ON drafting."""
from models.schema import ColumnSpec, TableSpec
from web.metadata_checker import check_metadata_completeness, draft_comment_ddl
